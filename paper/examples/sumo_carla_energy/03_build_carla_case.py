"""Build CARLA OpenDRIVE scripts for the bundled Tempe paper dataset."""
...
def main() -> None:
    """Create CARLA client scripts without requiring a running CARLA server."""
    ...
    print(f"CARLA case built under: {result['project_dir']}")
